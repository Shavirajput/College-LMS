    ...
    <body class="grey lighten-4">
        <nav class="blue">
            <div class="nav-wrapper">
                <a href="/eresource" class="brand-logo center" title="ICSC eResources"><img src="/eresource/assets/images/logo-gdc.png" style="margin-top:10px; width:200px; height:40px;"></a>
            </div>
        </nav>