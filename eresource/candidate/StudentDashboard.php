...
<!DOCTYPE html>
    <html>
        <head>
            ...
            <div class="container">
                <h3 class="center">Hi <span style="text-transform:capitalize;"><b><?php echo htmlspecialchars($_SESSION["stu_name"]); ?></b>!</span>, Welcome to <span class="teal-text">GDC Ganderbal eResources</span>.</h3>
                <br><br>
