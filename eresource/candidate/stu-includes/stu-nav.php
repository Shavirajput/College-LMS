<meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no">
            ...
            <body class="grey lighten-4">
                <div class="row">
                    ...
                    <?php $site_logo = "<img src='/eresource/assets/images/logo-gdc.png' style='margin-top:10px; width:200px; height:40px;'>" ?>
                    <div class="navbar-fixed z-depth-3">
                        <nav class="blue">
			                <div class="nav-wrapper">
				                <a href="/eresource/candidate" class="brand-logo hide-on-med-and-down" style="margin-left: 420px" title="GDC Ganderbal eResources"><?php echo $site_logo ?></a>
				                <a href="/eresource" class="brand-logo center hide-on-large-only" title="GDC Ganderbal eResources"><img src='/eresource/assets/images/logo-gdc.png' style='margin-top:10px; width:200px; height:40px;'></a>
                                ...
                                <ul class="sidenav sidenav-fixed right hide-on-med-and-down">
					                <li>
                                        <div class="user-view">
                                            ...
                                            <a href="#student"><img class="circle" src="/eresource/assets/images/logo-gdc.png"></a>
